...
parser.add_argument('--output_csv_path', type=str, default='/nasdata4/kwonhwi/GraphTransformer/GraphTransformer_BrainAge/ugugugugugugug/gcn2_onlydti_gt_loss.csv')
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(net.state_dict(), os.path.join(model_path, 'best_model_GCN2_GT_onlydti.pth'))
