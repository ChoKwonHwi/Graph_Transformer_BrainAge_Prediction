...
class Brain_network(graph_dataset):
    ...
    def process(self):
        # define file paths
        node_path = os.path.join('/nasdata4/kwonhwi/GraphTransformer/GraphTransformer_BrainAge/brain_network/project2/Fusion/node_feature')
        adjacency_path = os.path.join('/nasdata4/kwonhwi/GraphTransformer/GraphTransformer_BrainAge/brain_network/project2/Fusion/adjacency_matrix')
        age_path = os.path.join('/nasdata4/kwonhwi/GraphTransformer/GraphTransformer_BrainAge/brain_network/project2/Fusion/age')
